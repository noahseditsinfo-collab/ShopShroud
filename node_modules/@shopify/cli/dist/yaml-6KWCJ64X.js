import{b as nr,g as Pt}from"./chunk-VKWPEFWQ.js";function hr(t){return this[t<0?this.length+t:t]}function Er(t){if(typeof t=="string")return an;if(Array.isArray(t))return ln;if(!t)return;let{type:e}=t;if(mn.has(e))return e}function br(t){let e=t===null?"null":typeof t;if(e!=="string"&&e!=="object")return`Unexpected doc '${e}', 
...
`)+`
`}};e._defineProperty(l,"defaults",b),t.Document=l,t.defaultOptions=g,t.scalarOptions=y}),fr=Me(t=>{"use strict";var e=cr(),r=ur(),u=tn(),g=Pe(),y=Xt();Ve();function b(q,z=!0,K){K===void 0&&typeof z=="string"&&(K=z,z=!0);let ee=Object.assign({},r.Document.defaults[r.defaultOptions.version],r.defaultOptions);return new u.Schema(ee).createNode(q,z,K)}var A=class extends r.Document{constructor(q){super(Object.assign({},r.defaultOptions,q))}};function k(q,z){let K=[],ee;for(let ce of e.parse(q)){let M=new A(z);M.parse(ce,ee),K.push(M),ee=M}return K}function C(q,z){let K=e.parse(q),ee=new A(z).parse(K[0]);if(K.length>1){let ce="Source contains multiple documents; please use YAML.parseAllDocuments()";ee.errors.unshift(new g.YAMLSemanticError(K[1],ce))}return ee}function P(q,z){let K=C(q,z);if(K.warnings.forEach(ee=>y.warn(ee)),K.errors.length>0)throw K.errors[0];return K.toJSON()}function F(q,z){let K=new A(z);return K.contents=q,String(K)}var ie={createNode:b,defaultOptions:r.defaultOptions,Document:A,parse:P,parseAllDocuments:k,parseCST:e.parse,parseDocument:C,scalarOptions:r.scalarOptions,stringify:F};t.YAML=ie}),sn=Me((t,e)=>{e.exports=fr().YAML}),pr=Me(t=>{"use strict";var e=Ve(),r=Pe();t.findPair=e.findPair,t.parseMap=e.resolveMap,t.parseSeq=e.resolveSeq,t.stringifyNumber=e.stringifyNumber,t.stringifyString=e.stringifyString,t.toJSON=e.toJSON,t.Type=r.Type,t.YAMLError=r.YAMLError,t.YAMLReferenceError=r.YAMLReferenceError,t.YAMLSemanticError=r.YAMLSemanticError,t.YAMLSyntaxError=r.YAMLSyntaxError,t.YAMLWarning=r.YAMLWarning}),dr={};Vt(dr,{__parsePrettierYamlConfig:()=>Ws,languages:()=>Ni,options:()=>Ai,parsers:()=>xn,printers:()=>Bs});on=(t,e)=>(r,u,...g)=>r|1&&u==null?void 0:(e.call(u)??u[t]).apply(u,g);mr=on("at",function(){if(Array.isArray(this)||typeof this=="string")return hr}),ve=mr,gr=String.prototype.replaceAll??function(t,e){return t.global?this.replace(t,e):this.split(t).join(e)},yr=on("replaceAll",function(){if(typeof this=="string")return gr}),ot=yr,vr=()=>{},tt=vr,an="string",ln="array",cn="cursor",un="indent",wt="align",fn="trim",Ot="group",Nt="fill",Lt="if-break",pn="indent-if-break",At="line-suffix",dn="line-suffix-boundary",De="line",hn="label",Mt="break-parent",mn=new Set([cn,un,wt,fn,Ot,Nt,Lt,pn,At,dn,De,hn,Mt]);gn=Er,Sr=t=>new Intl.ListFormat("en-US",{type:"disjunction"}).format(t);wr=class extends Error{name="InvalidDocError";constructor(t){super(br(t)),this.doc=t}},Or=wr;Be=tt,yn=tt,Ar=tt,Mr=tt;Tt={type:Mt};Qe={type:De},En={type:De,soft:!0},kr={type:De,hard:!0},H=[kr,Tt],Cr={type:De,hard:!0,literal:!0},gt=[Cr,Tt];Fs=rt(/\s/u),_t=rt(" 	"),qs=rt(",; 	"),Ks=rt(/[^\n\r]/u),Yt=t=>t===`
`||t==="\r"||t==="\u2028"||t==="\u2029";Bt=Pr;Sn=$r,Rr=class extends Error{name="UnexpectedNodeError";constructor(t,e,r="type"){super(`Unexpected ${e} node ${r}: ${JSON.stringify(t[r])}.`),this.node=t}},_r=Rr,Yr="format",Br=/^\s*#[^\S\n]*@(?:noformat|noprettier)\s*?(?:\n|$)/u,Dr=/^\s*#[^\S\n]*@(?:format|prettier)\s*?(?:\n|$)/u,Wr=/^\s*@(?:format|prettier)\s*$/u,jr=t=>Wr.test(t),Fr=t=>Dr.test(t),qr=t=>Br.test(t),Kr=t=>`# @${Yr}

${t}`;bn.ignoredProperties=new Set(["position"]);Ur=bn;wn.getVisitorKeys=()=>[];Vr=wn,Fe=null;Qr=10;for(let t=0;t<=Qr;t++)Ue();Hr=Gr,ae=[["children","anchor","tag","indicatorComment","leadingComments","middleComments","trailingComment","endComments"],["anchor","tag","indicatorComment","leadingComments","middleComments","trailingComment","endComments"],["key","value","children","anchor","tag","indicatorComment","leadingComments","middleComments","trailingComment","endComments"],["content","children","anchor","tag","indicatorComment","leadingComments","middleComments","trailingComment","endComments"],["indicatorComment","leadingComments","middleComments","trailingComment","endComments"]],zr={root:ae[0],document:["head","body","children","anchor","tag","indicatorComment","leadingComments","middleComments","trailingComment","endComments"],documentHead:ae[0],documentBody:ae[0],directive:ae[1],alias:ae[1],blockLiteral:ae[1],blockFolded:ae[0],plain:ae[0],quoteSingle:ae[1],quoteDouble:ae[1],mapping:ae[0],mappingItem:ae[2],mappingKey:ae[3],mappingValue:ae[3],sequence:ae[0],sequenceItem:ae[3],flowMapping:ae[0],flowMappingItem:ae[2],flowSequence:ae[0],flowSequenceItem:ae[3],comment:ae[1],tag:ae[4],anchor:ae[4]},Xr=Hr(zr),Zr=Xr,xt=t=>t.position.start.offset,ei=t=>t.position.end.offset;Je=ti;at=new WeakMap;li=ai;di=ui;gi=hi;wi={preprocess:gi,embed:Vr,print:yi,massageAstNode:Ur,insertPragma:Kr,getVisitorKeys:Zr},Oi=wi,Ni=[{name:"YAML",type:"data",aceMode:"yaml",extensions:[".yml",".mir",".reek",".rviz",".sublime-syntax",".syntax",".yaml",".yaml-tmlanguage",".yaml.sed",".yml.mysql"],filenames:[".clang-format",".clang-tidy",".clangd",".gemrc","CITATION.cff","glide.lock","pixi.lock",".prettierrc",".stylelintrc",".lintstagedrc"],tmScope:"source.yaml",aliases:["yml"],codemirrorMode:"yaml",codemirrorMimeType:"text/x-yaml",parsers:["yaml"],vscodeLanguageIds:["yaml","ansible","dockercompose","github-actions-workflow","home-assistant"],linguistLanguageId:407}],ct={bracketSpacing:{category:"Common",type:"boolean",default:!0,description:"Print spaces between brackets.",oppositeDescription:"Do not print spaces between brackets."},objectWrap:{category:"Common",type:"choice",default:"preserve",description:"How to wrap object literals.",choices:[{value:"preserve",description:"Keep as multi-line, if there is a newline between the opening brace and first property."},{value:"collapse",description:"Fit to a single line when possible."}]},singleQuote:{category:"Common",type:"boolean",default:!1,description:"Use single quotes instead of double quotes."},proseWrap:{category:"Common",type:"choice",default:"preserve",description:"How to wrap prose.",choices:[{value:"always",description:"Wrap prose if it exceeds the print width."},{value:"never",description:"Do not wrap prose."},{value:"preserve",description:"Wrap prose as-is."}]},bracketSameLine:{category:"Common",type:"boolean",default:!1,description:"Put > of opening tags on the last line instead of on a new line."},singleAttributePerLine:{category:"Common",type:"boolean",default:!1,description:"Enforce single attribute per line in HTML, Vue and JSX."}},Li={bracketSpacing:ct.bracketSpacing,singleQuote:ct.singleQuote,proseWrap:ct.proseWrap},Ai=Li,xn={};Vt(xn,{yaml:()=>Ys});jt=bt(sn(),1),Ee=bt(pr(),1),Us=Ee.default.findPair,Vs=Ee.default.toJSON,Qs=Ee.default.parseMap,Js=Ee.default.parseSeq,Gs=Ee.default.stringifyNumber,Hs=Ee.default.stringifyString,zs=Ee.default.Type,Xs=Ee.default.YAMLError,Zs=Ee.default.YAMLReferenceError,Mi=Ee.default.YAMLSemanticError,eo=Ee.default.YAMLSyntaxError,to=Ee.default.YAMLWarning;(function(t){t.Tag="!",t.Anchor="&",t.Comment="#"})(Ye||(Ye={}));(function(t){t.CLIP="clip",t.STRIP="strip",t.KEEP="keep"})(Et||(Et={}));Os=class{text;comments=[];#e;#t;constructor(t,e){this.text=e,this.#e=t}setOrigRanges(){if(!this.#e.setOrigRanges())for(let t of this.#e)t.setOrigRanges([],0)}#n(t){if(!ut){let[y]=this.#e,b=Object.getPrototypeOf(Object.getPrototypeOf(y));ut=Object.getOwnPropertyDescriptor(b,"rangeAsLinePos").get}if(this.#t??(this.#t={root:{context:{src:this.text}}}),this.text===""&&t.origStart===0&&t.origEnd===0)return{start:{offset:0,line:1,column:1},end:{offset:0,line:1,column:1}};let{start:{line:e,col:r},end:{line:u,col:g}}=ut.call({range:{start:this.#r(t.origStart),end:this.#r(t.origEnd)},context:this.#t});return{start:{offset:t.origStart,line:e,column:r},end:{offset:t.origEnd,line:u,column:g}}}#r(t){return t<0?0:t>this.text.length?this.text.length:t}transformOffset(t){return this.#n({origStart:t,origEnd:t}).start}transformRange(t){let{start:e,end:r}=this.#n(t);return Ie(e,r)}transformNode(t){return ws(t,this)}transformContent(t){return In(t,this)}},Ns=Os;Rs=$s;Ys={astFormat:"yaml",parse:_s,hasPragma:Fr,hasIgnorePragma:qr,locStart:xt,locEnd:ei},Bs={yaml:Oi},Ds=bt(sn(),1),Ws=Ds.default.parse});js();export{Ws as __parsePrettierYamlConfig,dr as default,Ni as languages,Ai as options,xn as parsers,Bs as printers};
