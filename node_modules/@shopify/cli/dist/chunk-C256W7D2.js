import{a as v}from"./chunk-E3RQCWSC.js";import{a as m}from"./chunk-R26GJEH3.js";import{a as u}from"./chunk-QU5NL2QT.js";import{a as y}from"./chunk-FPWLEGKZ.js";import{d as f}from"./chunk-6BX62FFE.js";import{p,v as c}from"./chunk-Z5DDPQ26.js";import{b as h,e as d}from"./chunk-2Y6CYLKF.js";import{ua as l}from"./chunk-EZ7EBYDT.js";import{a as F}from"./chunk-CTNBSUVU.js";import{e as O,g as a}from"./chunk-VKWPEFWQ.js";a();var t=O(F(),1);var w,o=class extends c{async command(r,n){let{ignore:g=[],only:_=[]}=r;l("theme-command:dev:single-env:authenticated");let i,e;if(r.theme){let s={filter:{theme:r.theme}};i=await u(n,s),e={...r,theme:i.id.toString(),store:n.storeFqdn}}else{i=await new m(n).findOrCreate();let s=r["theme-editor-sync"]&&i.createdAtRuntime;e={...r,theme:i.id.toString(),store:n.storeFqdn,"overwrite-json":s}}await f(i,"start development mode",r["allow-live"])&&(await v({adminSession:n,commandConfig:this.config,directory:e.path,store:e.store,password:e.password,storePassword:e["store-password"],theme:i,listing:e.listing,host:e.host,port:e.port,"live-reload":e["live-reload"],"error-overlay":e["error-overlay"],force:e.force,open:e.open,"theme-editor-sync":e["theme-editor-sync"],"standard-events-inspector":e["standard-events-inspector"],reconciliationStrategy:e["reconciliation-strategy"],noDelete:e.nodelete,ignore:g,only:_,notify:e.notify}),await y({path:e.path,password:e.password,store:e.store,force:e.force,verbose:e.verbose,noColor:e["no-color"],silent:!0}))}};w=o;o.summary="Uploads the current theme as a development theme to the connected store, then prints theme editor and preview URLs to your terminal. While running, changes will push to the store in real time.";o.descriptionWithMarkdown=`
...
You can run this command only in a directory that matches the [default Shopify theme folder structure](https://shopify.dev/docs/themes/tools/cli#directory-structure).`;o.description=w.descriptionWithoutMarkdown();o.flags={...h,...p,host:t.Flags.string({description:"Set which network interface the web server listens on. The default value is 127.0.0.1.",env:"SHOPIFY_FLAG_HOST"}),"live-reload":t.Flags.string({description:`The live reload mode switches the server behavior when a file is modified:
