...
`).map(t=>t.trim()).join(" ")};$.O=function(e){return this.inspectOpts.colors=this.useColors,_.inspect(e,this.inspectOpts)}});var Ee=O((ke,S)=>{p();typeof process>"u"||process.type==="renderer"||process.browser===!0||process.__nwjs?S.exports=U():S.exports=V()});export{z as a,Ee as b};
