import{b as ln,g as Ke}from"./chunk-VKWPEFWQ.js";function mn(t){return this[t<0?this.length+t:t]}function yn(t){if(typeof t=="string")return Ar;if(Array.isArray(t))return Dr;if(!t)return;let{type:e}=t;if(Br.has(e))return e}function An(t){let e=t===null?"null":typeof t;if(e!=="string"&&e!=="object")return`Unexpected doc '${e}', 
